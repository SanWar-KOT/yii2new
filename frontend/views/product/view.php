        ...
        <div class="product-information"><!--/product-information-->
            ...
            <img src="/images/product-details/rating.png" alt="" />
								<span>
									...
									<a type="button" href="<?= \yii\helpers\Url::to(['cart/add', 'id' => $products->id])?>" data-id="<?= $products->id?>" class="btn btn-fefault cart add-to-cart">
            ...
            <p><b>Brand:</b> <a href="<?= \yii\helpers\Url::to(['category/view', 'id' => $products->category->id]) ?>"><?= $products->category->name?></a></p>
